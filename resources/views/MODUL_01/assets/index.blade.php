...
<head>
    ...
    <title>Praktikum Modul_01</title>
...
<div id="bs-icons">
    ...
    <div class="container py-5 px-4">
        <div class="row">
            ...
            <div class="col-lg-6">
                <img class="img-fluid" src="{{ asset('images/bs-icons.png') }}" src="images/images/bs-icons.png" alt="bootstrap-icons">
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-3 mb-5">
                <a href="" class="logo text-decoration-none">
                    <div class="d-flex">
                        <img src="images/images/logo-black.svg" alt="" class="img-fluid" style="width: 40px;">
